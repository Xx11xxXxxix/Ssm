module.exports = {
	...
	Login: 'http://localhost:3000/platform-framework/api/auth/login', // 新添加的本地登录端点
	Code: 'http://localhost:3000/platform-framework/api/code',
	IndexUrlNewGoods: 'http://localhost:3000/platform-framework/api/index/newGoods',
	IndexUrlHotGoods: 'http://localhost:3000/platform-framework/api/index/hotGoods',
	IndexUrlTopic: 'http://localhost:3000/platform-framework/api/index/topic',
	IndexUrlBrand: 'http://localhost:3000/platform-framework/api/index/brand',
	IndexUrlCategory: 'http://localhost:3000/platform-framework/api/index/category',
	IndexUrlBanner: 'http://localhost:3000/platform-framework/api/index/banner',
	IndexUrlChannel: 'http://localhost:3000/platform-framework/api/index/channel' ,
	...
	SmsCode: 'http://localhost:3000/platform-framework/api/smscode', // 
