<template>
	<view class="container">
        ...
        <navigator v-if="item.link" :url="item.link">
          ...
          <image :src="require('@/static/images/备用金.png')" background-size="cover"></image>
			<image :src="require('@/static/images/碎屏保障.png')" background-size="cover"></image>

        </navigator>
		<view>
			<image :src="('@/static/images/碎屏保障.png')" background-size="cover"></image>
		</view>
				<!-- <image v-else :src="item.imageUrl" background-size="cover"></image> -->
			</swiper-item>
		</swiper>
		<view class="1h">
			<image  class="full-width-image"  :src="('/static/images/碎屏保障.png')" ></image>
		</view>	
      ...
      <!-- 精选推荐 -->
		<view class="a-section a-recommendation" v-if="topics.length > 0">
			<view class="h">
				<text class="title">邦推推品牌保证</text>
	
			</view>
			<view class="2h">
				<image  class="full-width-image-1"  :src="('/static/images/官方严选.png')" ></image>
				</view>	
		</view>
